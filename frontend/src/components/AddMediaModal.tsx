        ...
        >
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {item.mediaType !== "MANGA" && (
              <label
                className={`rounded-xl border border-slate-800 bg-slate-950/40 p-3 ${item.mediaType === "NOVEL" && !isDelete
                    ? "sm:col-span-2 sm:mx-auto sm:w-1/2 text-center"
                    : ""
                  }`}
              >
                ...
                <input
                  ...
                  className={`mt-1 w-full border-b border-slate-800 bg-transparent py-0.5 text-xl font-bold text-white outline-none focus:border-indigo-500 transition-colors ${item.mediaType === "NOVEL" && !isDelete ? "text-center" : ""
                    }`}
                />
              </label>
            )}
            {(item.mediaType !== "NOVEL" || isDelete) && (
              <div className={`rounded-xl border border-slate-800 bg-slate-950/40 p-3 flex flex-col justify-center ${item.mediaType === "MANGA" ? "sm:col-span-2 sm:mx-auto sm:w-1/2" : ""
                }`}>
                <span className="block text-[9px] font-bold uppercase tracking-wider text-slate-500">
          ...
          <div className="mt-5 flex justify-end gap-2.5 border-t border-slate-800 pt-4">
            ...
            <button
              ...
              disabled={isAdding}
              className={`rounded-lg px-5 py-2 text-xs font-bold text-white transition disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer shadow-sm ${isDelete
